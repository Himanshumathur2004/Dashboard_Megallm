...
class Config:
    ...
    # AGIorBust account configuration (AI automation content style)
    AGIORBUST_ACCOUNT_ID = os.getenv("AGIORBUST_ACCOUNT_ID", "account_3")
    ...
    # AGIorBust Topics (AI automation, platform updates, integrations)
    AGIORBUST_TOPICS = {
        "platform_updates": {
            "name": "Platform Updates & Integrations",
            "description": "Latest AI platform updates, feature releases, and connector integrations",
            "keywords": ["update", "release", "integration", "connector", "API", "feature", "announcement", "connect"],
            "blogs_per_cycle": 4
        },
        "ai_tools": {
            "name": "AI Tools & Automation",
            "description": "Review and tutorials on AI-powered automation tools and workflows",
            "keywords": ["automation", "workflow", "tool", "ai-powered", "integration", "automate", "workflow"],
            "blogs_per_cycle": 4
        },
        "industry_news": {
            "name": "Industry News & AI Landscape",
            "description": "Company announcements, partnerships, and major trends in AI automation",
            "keywords": ["news", "announcement", "partnership", "collaboration", "company", "trend", "market"],
            "blogs_per_cycle": 4
        },
        "comparisons": {
            "name": "Tool & Platform Comparisons",
            "description": "Side-by-side comparisons and evaluations of AI automation platforms",
            "keywords": ["comparison", "review", "versus", "vs", "evaluate", "review", "analysis", "comparison"],
            "blogs_per_cycle": 4
        }
    }

    BLOGS_PER_24_HOURS = 12  # 3 per topic × 4 topics
    AGIORBUST_BLOGS_PER_24_HOURS = 16  # 4 per topic × 4 topics
    GENERATION_INTERVAL_MINUTES = 120  # Generate 12 blogs every 24 hours means 1 every 2 hours
    AGIORBUST_GENERATION_INTERVAL_MINUTES = 90  # Generate 16 blogs every 24 hours means 1 every 1.5 hours
