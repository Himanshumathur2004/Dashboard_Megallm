...
export const CONFIG = {
  ...
  posts: {
    topDays: 7,             // (deprecated - now using published date for recent articles)
    minReactions: 1,        // Lowered: fetch recent articles, not just popular ones
    maxComments: 200,       // Skip huge threads
    articlesPerTag: 8,      // Fetch up to 8 per tag
  },
